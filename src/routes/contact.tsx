...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "تواصل مع فريق Bouiba Academy — لأسئلتك، اقتراحاتك، أو فرص التعاون في محتوى الذكاء الاصطناعي العربي." },
      { property: "og:title", content: "تواصل معنا — Bouiba Academy" },
      { property: "og:description", content: "راسل فريق Bouiba Academy لأي سؤال، اقتراح، أو تعاون في محتوى الذكاء الاصطناعي." },
      { property: "og:url", content: "https://www.bouibacademy.me/contact" },
    ],
    links: [{ rel: "canonical", href: "https://www.bouibacademy.me/contact" }],
  }),
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container-page py-16">
        <div className="grid gap-6 md:grid-cols-3 max-w-4xl mx-auto">
          {[
            { icon: Mail, title: "البريد الإلكتروني", value: "contact@bouibacademy.me", href: "mailto:contact@bouibacademy.me" },
            { icon: MessageCircle, title: "الرسائل", value: "عبر صفحات التواصل", href: "#" },
            { icon: Globe, title: "المدونة", value: "bouibacademy.me", href: "https://www.bouibacademy.me" },
          ].map((c, i) => (
            <a
              key={i}
              href={c.href}
        ...
        <form className="mt-14 max-w-2xl mx-auto rounded-2xl border border-border bg-card p-8 shadow-card">
          ...
          <div className="grid gap-4">
            ...
            <label htmlFor="contact-subject" className="sr-only">الموضوع</label>
            <input
              id="contact-subject"
              type="text"
              placeholder="الموضوع"
