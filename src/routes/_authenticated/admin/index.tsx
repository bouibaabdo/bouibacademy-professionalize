...
function AdminOverview() {
  ...
  const cards = [
    ...
    { title: "متابعات المستخدمين", value: stats?.favoritesCount, icon: Heart, color: "text-rose-500" },
  ];
      ...
      <Card>
        ...
        <CardContent className="grid gap-3 md:grid-cols-2">
          <a href="https://www.blogger.com/" target="_blank" rel="noopener noreferrer"
            ...
            <p className="text-xs text-muted-foreground mt-1">افتح لوحة Blogger لإنشاء أو تعديل مقال.</p>
          </a>
