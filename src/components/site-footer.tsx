      ...
      <div className="container-page py-14">
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            <Link to="/" className="inline-flex items-center gap-2 mb-3" aria-label="Bouiba Academy">
              <img src={bouibaLogo.url} alt="Bouiba Academy" className="h-12 w-auto" width={48} height={48} />
            </Link>
            <p className="text-sm text-muted-foreground max-w-md leading-relaxed">
              أكاديميتك العربية للذكاء الاصطناعي — دروس عملية، أحدث الأخبار، وأدوات مجانية
              لمواكبة عصر الذكاء الاصطناعي.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link to="/posts" className="hover:text-foreground">جميع المقالات</Link></li>
              <li><Link to="/posts" search={{ label: "دروس" }} className="hover:text-foreground">الدروس</Link></li>
              <li><Link to="/posts" search={{ label: "أدوات" }} className="hover:text-foreground">أدوات AI</Link></li>
              <li><Link to="/posts" search={{ label: "أخبار" }} className="hover:text-foreground">الأخبار</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/disclaimer" className="hover:text-foreground">إخلاء المسؤولية</Link></li>
            </ul>
          </div>
